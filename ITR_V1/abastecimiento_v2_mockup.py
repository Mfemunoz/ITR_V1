...
.block-container {padding-top:1.4rem;padding-left:2rem;padding-right:2rem;}
...
section[data-testid="stSidebar"] > div {padding-left:1rem;padding-right:1rem;}
...
.app-title {color:var(--sodimac-red);margin-bottom:0;font-size:34px;font-weight:800;letter-spacing:0;white-space:nowrap;line-height:1.1;}
.app-subtitle {color:var(--sodimac-blue-dark);margin-top:0.8rem;border-left:8px solid var(--sodimac-yellow);padding-left:10px;font-size:24px;font-weight:700;}
.sidebar-title {display:flex;align-items:center;gap:10px;font-size:24px;color:var(--sodimac-ink);line-height:1.15;margin:18px 0 14px 0;}
...
col_title, col_status = st.columns([4.6, 1.4])
with col_title:
    st.markdown(
        "<h1 class='app-title'>SODIMAC COLOMBIA - DESARROLLO LOGISTICO</h1>"
        "<h3 class='app-subtitle'>Centro de Control de Abastecimiento</h3>",
        unsafe_allow_html=True
    )
with col_status:
    if secondary_logo:
        ...
        with tab_indicadores:
            ...
            if mapa_ok.empty:
                ...
                fig_mapa = px.scatter_mapbox(
                    ...
                    hover_data={'Tienda': True, 'Casos': True, 'Latitud': False, 'Longitud': False},
                    title='Top tiendas con registros',
                    color_continuous_scale=['#eef6fc', '#0072bc', '#004b8d'],
                )
                ...
                st.caption('Mapa basado en OpenStreetMap. Permite acercar para ver vías principales y referencias urbanas. Para división exacta por departamentos se puede integrar un GeoJSON oficial en una siguiente versión.')
