...
with st.sidebar:
    ...
    selected = option_menu(
        'Centro de Control',
        ['Planeación ITR', 'Ejecución Abastecimiento', 'TMS', 'Consulta Individual', 'Consulta Masiva', 'Dashboard Ejecutivo', 'Auditoría', 'Reportes'],
        icons=['calendar-week', 'box-seam', 'truck', 'search', 'upload', 'bar-chart', 'clipboard-data', 'file-earmark-arrow-down'],
        default_index=0
    )
