...
div[data-testid="stTabs"] button[aria-selected="true"] {color:var(--sodimac-red);}
...
with col_title:
    st.markdown(
        "<h1 style='color:#ed1c24;margin-bottom:0;'>SODIMAC COLOMBIA</h1>"
...
with st.sidebar:
    ...
    if fuente_datos == 'Archivo local':
        uploaded_file = st.file_uploader('Cargar archivo operativo', type=['xlsx', 'csv'])
