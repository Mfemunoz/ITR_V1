...
with st.sidebar:
    ...
    selected = option_menu(
        'Centro de Control',
        ['Inicio', 'Consulta Individual', 'Consulta Masiva', 'Dashboard Ejecutivo', 'TMS', 'Auditoría', 'Reportes'],
        icons=['house', 'search', 'upload', 'bar-chart', 'truck', 'clipboard-data', 'file-earmark-arrow-down'],
        default_index=0
    )
