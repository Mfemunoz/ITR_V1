...
.top-band {background:white;border-left:6px solid var(--sodimac-yellow);padding:14px 18px 14px 18px;border-radius:8px;box-shadow:0 4px 14px rgba(0,75,141,0.08);}
.app-title {color:var(--sodimac-red);margin-bottom:0;font-size:28px;font-weight:800;letter-spacing:0;white-space:nowrap;line-height:1.05;}
